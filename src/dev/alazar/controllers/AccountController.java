package dev.alazar.controllers;
...
public class AccountController {
	...
	public Handler getAccountById = (ctx) -> {
		...
		String input1 = ctx.pathParam("clientId");
		...
		try {
			id = Integer.parseInt(input);
			clientId = Integer.parseInt(input1);
		...
		Account a = as.getAccount(id, clientId);
	...
	public Handler deleteAccount = (context) -> {
		...
		// Gets variables/values to use from app.class/client side
		String input1 = context.pathParam("id");
		String input = context.pathParam("id");
